#' ---
#' title: "Analysis of MITx/6.00x/2013_Spring"
#' author: Pavan Gurazada
#' output: github_document
#' ---
#' last update: Thu Apr 26 11:24:58 2018
...
mooc_df %>% 
  filter(course_id == "MITx/6.00x/2013_Spring") %>% 
...
#' MIT 6.00x is an introduction to computer science using Python. 
...
#' There is hardly any dropout in comparison with the previous courses
...
confusionMatrix(mit600x_neng_rf)
