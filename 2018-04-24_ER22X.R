#' ---
#' title: "Analysis of ER22x"
#' author: Pavan Gurazada
#' output: github_document
#' ---

#' last update: Tue Apr 24 15:23:37 2018
...
#' The ER22x course is an introduction to contemporary issues on Justice. The
#' course featues discussions about political controversies that raise
